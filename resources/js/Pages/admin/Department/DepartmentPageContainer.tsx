...
type DepartmentPageContainerProps = PageProps & {
    data: BaseListResponse<DepartmentType>;
};
const DepartmentPageContainer: React.FC<DepartmentPageContainerProps> = ({
    auth,
    data,
    flash,
}) => {
    ...
    const onEditRecord: TableDataProps<DepartmentType>["onEdit"] = (record) => {
