...
import { Button, Col, Form, Row, Select, SelectProps, Switch } from "antd";
...
const MemberForm: React.FC<MemberFormProps> = ({
    ...
    const {
        props: {
            share: { companies, departments },
        },
    } = usePage();

    const handleChangeCompany: SelectProps<string, CompanyType>["onChange"] = (
        value
    ) => {
        onChange?.("company_id", value);
    };

    const handleChangeDepartment: SelectProps<
        string,
        DepartmentType
    >["onChange"] = (value) => {
